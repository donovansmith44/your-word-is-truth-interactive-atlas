...
//! pinning `min_version`/`max_version` to "0.5.0"/"0.5.0" (LEX-1; 0.4.0 DB-4c, 0.3.0 DB-4b, 0.2.0 DB-4a, 0.1.0 before) for the drift-
...
pub const MIN_SUPPORTED_VERSION: &str = "0.5.0";
pub const MAX_SUPPORTED_VERSION: &str = "0.5.0";
